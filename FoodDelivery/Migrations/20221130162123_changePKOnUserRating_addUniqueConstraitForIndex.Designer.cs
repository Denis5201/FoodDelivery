...
namespace FoodDelivery.Migrations
{
    ...
    [Migration("20221130162123_changePKOnUserRating_addUniqueConstraitForIndex")]
    partial class changePKOnUserRatingaddUniqueConstraitForIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DishOrder", b =>
                {
                    b.HasOne("FoodDelivery.Models.Entity.Dish", null)
                        .WithMany()
                        .HasForeignKey("DishesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Models.Entity.Order", null)
                        .WithMany()
